  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <section className="p-6 flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-4 text-gray font-medium">
            <button
              ...
              value="cabelo"
              className={`${
                service == "cabelo" && "bg-orange border-orange text-background"
            ...
            <button
              ...
              value="barba"
              className={`${
                service == "barba" && "bg-orange border-orange text-background"
              } border border-gray rounded-lg p-2 hover:opacity-80 transition-all duration-300`}
            >
              Corte de barba
            </button>
        ...
        <button className="bg-done h-9 rounded-lg hover:opacity-80 transition-all duration-300">
          Confirmar
        </button>
      </section>
    </main>
